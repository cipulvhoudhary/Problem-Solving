...
class Clone {
    ...
    Node copyList(Node head) {
        ...
        // Step 1 : clone a list using next pointer only 
        // Step 2 :: while cloning, make a map <original node , duplicate node> as <K, V>
        ...
        while(t1 != null) {
            Node arbitary = t1.arb;
            t2.arb = map.get(arbitary);
            t1 = t1.next;
            t2 = t2.next;
        }
        return head2;
